...
import notFoundStyle from "./NotFoundPage.module.css";
...
function NotFoundPage() {
  ...
  return (
    <div className={notFoundStyle["bg404"]}>
      <svg
        version="1.1"
        className={notFoundStyle["error-404-img"]}
        x="0px"
        y="0px"
        viewBox="0 0 344.7 276.7"
        style={{ enableBackground: "new 0 0 344.7 276.7" }}
      >
        <g className={notFoundStyle["decorations"]}>
          <polygon
            className={notFoundStyle["st0"]}
  ...
  304.5,202.7 307.7,205.9 311,202.6 307.9,199.4 	"
    ...
    C261.8,168.7,259.6,170.8,257,170.8z M257,163.2c-1.6,0-2.8,1.3-2.8,2.8s1.3,2.8,2.8,2.8s2.8-1.3,2.8-2.8S258.5,163.2,257,163.2z"
     ...
     M90,224.3c-1.6,0-2.8,1.3-2.8,2.8s1.3,2.8,2.8,2.8s2.8-1.3,2.8-2.8S91.5,224.3,90,224.3z"
          ...
          <circle className={notFoundStyle["st0"]} cx="98.9" cy="65.3" r="9" />
          <circle
            className={notFoundStyle["st0"]}
            cx="103.3"
            cy="168.8"
        ...
        <g className={notFoundStyle["_x34_-gauche"]}>
          <g className={notFoundStyle["st1"]}>
            <path
              className={notFoundStyle["st0"]}
...
c0.5,0.6,1.4,0.6,1.9,0.1l0.4-0.3l56.2,61.4h21.4L238.6,173z"
        />
        <g className={notFoundStyle["_x34_-droite"]}>
          <g className={notFoundStyle["st1"]}>
            <path
              className={notFoundStyle["st0"]}
  ...
  c-28.5,0-51.7-23.1-51.7-51.7c0-28.5,23.1-51.7,51.7-51.7s51.7,23.1,51.7,51.7C215.7,145.5,192.5,168.7,164,168.7z"
          />
          <circle className={notFoundStyle["st9"]} cx="164" cy="117" r="51.7" />
          <path
            className={notFoundStyle["st2"]}
  ...
  C144.8,70.7,137.2,75.2,129.7,82.7z"
      ...
      <div className={notFoundStyle["notFound_info"]}>
        <h1 className={notFoundStyle["notFound_title"]}>
          Không tìm thấy trang !
        </h1>
        <div className={notFoundStyle["notFound_content"]}>
          Có vẻ như bạn đã bị lạc , trang bạn đang tìm kiếm không có sẵn !
        </div>
        <div
          className={notFoundStyle["notFound_btn"]}
          onClick={() => handleClick()}
        >
          Trở về Trang chủ
        </div>
